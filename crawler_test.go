...
func TestCrawlDB(t *testing.T) {
	...
	dbColumnNames := [...]string{"newsql", // tidb后花园
		...
		"c_1176293003416788992", //小Vcoding
	}
...
func TestCrawAiops(t *testing.T) {
	...
	aiopsColumnsNames := [...]string{
		...
		"c_1650446151097851904", // 人工智能开发随笔, 手推BP
		"c_188941548",           //深度学习前沿笔记
		"c_1612885940929720320", // 麦克船长AI专栏
		"c_1471819989803700224", //AiSecOps
		"c_1312178717184712705", //异常检测与诊断
		"c_1337341309129510912", //智能运维 AIOps 相关研究分享
		"c_1683852314232885248", //时空数据顶会论文总结
	}
